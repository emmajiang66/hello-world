...
def main():
    ...
    parser.add_argument('--w_size', type=int, default=30, dest='w_size')
    ...
    # Initialize weights
    w_1 = initialize_w(X.shape[1], args.w_size)
    ...
    ax[0].set_title("CA3 - Training a deep neural network Power Dataset")
